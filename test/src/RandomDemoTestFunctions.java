 ...
 */
public class RandomDemoTestFunctions extends AbstractJavaSamplerClient{

    private static Logger logger = LogManager.getLogger(RandomDemoTestFunctions.class.getName());
    private String x;
